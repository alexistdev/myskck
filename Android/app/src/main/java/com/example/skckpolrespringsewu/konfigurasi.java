package com.example.skckpolrespringsewu;
    ...
    public class konfigurasi {
        ...
        public static final String URL_ADD="http://http://192.168.43.49/skck/insert.php";
        ...
        public static final String KEY_EMP_KECAMATAN = "kecamatan"; //desg itu variabel untuk posisi
        public static final String KEY_EMP_KEBUTUHAN = "kebutuhan"; //salary itu variabel untuk gajih
